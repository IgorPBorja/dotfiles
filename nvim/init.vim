...
lua<<
	...
	-- this link has a fantastic doc of pycodestyle
	-- https://pycodestyle.pycqa.org/en/latest/intro.html#configuration
	-- globally, pycodestyle will read ~/.config/pycodestyle
	-- at the project level, it will look for a setup.cfg file (which overrides global options on ~/.config/pycodestyle)
	lspconfig.pylsp.setup { -- pylsp setup adapted from https://jdhao.github.io/2023/07/22/neovim-pylsp-setup/
		on_attach = on_attach,
		settings = {
...
function! s:ShowDebugMappings() abort
    let l:mappings = [
        ...
        \ '<Leader>dl: Step Into',
        \ '<Leader>dj: Step Over',
		\ '<Leader>di: Inspect object at cursor',
        \ ]
